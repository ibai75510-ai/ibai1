...
import {
  LayoutDashboard, LogOut, PanelLeft, Users, BookOpen, Newspaper,
  CalendarDays, FileText, Handshake, Building2, Mail, Image as ImageIcon,
} from "lucide-react";
...
const menuItems = [
  ...
  { icon: BookOpen, label: "Research Articles", path: "/dashboard/research" },
  { icon: Newspaper, label: "News", path: "/dashboard/news" },
  { icon: CalendarDays, label: "Events", path: "/dashboard/events" },
  { icon: FileText, label: "Paper Submissions", path: "/dashboard/submissions" },
  { icon: Handshake, label: "Recognition Requests", path: "/dashboard/recognition" },
  { icon: Building2, label: "Organizations", path: "/dashboard/organizations" },
  { icon: Mail, label: "Contacts", path: "/dashboard/contacts" },
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          ...
          <Button
            onClick={() => {
              window.location.href = `${LOGIN_PATH}?redirect=${encodeURIComponent(location.pathname)}`;
            }}
            size="lg"
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <img src="/images/logo.png" alt="IBAI" className="w-5 h-5 object-contain shrink-0" />
